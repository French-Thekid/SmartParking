...
export class VparkedPage implements OnInit {
  ...
  async returnSpot(spot: string) {
    ...
    if((spot=="02")||(spot=="04")||(spot=="06")||(spot=="08")||(spot=="10"))
    {
      ...
      const alert = await this.alertController.create({
        header: 'Parking Details',
        message: '<strong>Parking spot</strong> ' +spot+'<br><strong>Vehicle License</strong>: XXXX01<br><strong>Driver ID</strong>:1212121<br><strong>Driver Name</strong>: French_theKid',
        translucent: true,
        buttons: ['OK']
      });
      await alert.present();
